...
Figures \ref{fig:Dispersion} suggest phase velocities that increase with frequency and reach values of order 10km/s at the upper end of the measured band. A simple Lamb-mode estimate using rough CFRP parameters places the high-frequency A0 branch near ~3.8 km/s; both the empirical and theoretical numbers should be considered approximate.
