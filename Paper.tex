...
\begin{figure}
  \centering
  \includegraphics[width=0.5\linewidth]{Figures/Results/1-50khz + Defect.png}
  \caption{The reconstructed defect of a cube glued on the plate. Die red diamonds mark the transducer locations. The yellow square denotes the spot on which the metal Cube was glued onto. The heatmap maps the the reflectivity amplitude }
  \label{fig:Screenshot}
\end{figure}
